...
1. Download **[Runsheet-Pilot-mac.dmg](https://github.com/jimhoggey/RunsheetPilot-App/releases/latest/download/Runsheet-Pilot-mac.dmg)**.
...
```bash
curl -L https://github.com/jimhoggey/RunsheetPilot-App/releases/latest/download/Runsheet-Pilot-mac.zip -o /tmp/rp.zip && ditto -x -k /tmp/rp.zip /Applications && xattr -dr com.apple.quarantine "/Applications/Runsheet Pilot.app" && open "/Applications/Runsheet Pilot.app"
```
...
1. Download **[Runsheet-Pilot-windows.exe](https://github.com/jimhoggey/RunsheetPilot-App/releases/latest/download/Runsheet-Pilot-windows.exe)**.
...
```powershell
$ProgressPreference='SilentlyContinue'; iwr https://github.com/jimhoggey/RunsheetPilot-App/releases/latest/download/Runsheet-Pilot-windows.exe -OutFile "$HOME\Desktop\Runsheet Pilot.exe"
```
...
```bash
git clone https://github.com/jimhoggey/RunsheetPilot-App.git
cd Runsheetpilot
